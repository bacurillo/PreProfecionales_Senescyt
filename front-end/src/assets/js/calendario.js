...
function createCalendar(date, side) {
    ...
    setTimeout(() => {
        ...
        for (let i = 1; i < (startDate.getDay() || 7); i++) {
            ...
            emptyDivCol.style.width = "14.28%"; // Establece el ancho para los días vacíos
...
todayDayName.innerHTML = "Hoy es " + currentDate.toLocaleString("es-ES", {
    weekday: "long",
    day: "numeric",
    month: "short"
});
